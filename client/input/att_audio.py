...
class Receiver(object):
    ...
    def att_transcribe(self, audio_file_path, PERSONA_ONLY=False, MUSIC=False):
        ...
        response = requests.post('https://api.att.com/speech/v3/speechToText',
                    headers={'Authorization': 'Bearer %s' % auth_token.get('access_token'),
    ...
    def transcribe(self, audio_file_path, PERSONA_ONLY=False, MUSIC=False):
        """
            Performs ASR, transcribing an audio file and returning the result.
    ...
    def activeListen(self, THRESHOLD=None, LISTEN=True, MUSIC=False):
        ...
        if not LISTEN:
            ...
            return self.att_transcribe(AUDIO_FILE)
        ...
        if MUSIC:
            return self.att_transcribe(AUDIO_FILE, MUSIC=True)
